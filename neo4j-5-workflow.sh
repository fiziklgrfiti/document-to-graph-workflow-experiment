...
echo -e "${BLUE}Command: python neo4j_2c-langchain-document-to-graph-adaptive.py $script_args${NC}"
python neo4j_2c-langchain-document-to-graph-adaptive.py $script_args
