...
def extract_entities_relationships(text_chunk: str, chunk_idx: int = -1, max_attempts: int = 2) -> Dict[str, Any]:
    ...
    -Goal-
    Given a document identify all entities and all relationships among the identified entities.

    -Steps-
    1. Analyze the text and extract:
        i. ENTITIES: Identify all significant entities (people, places, things, concepts, etc.).
            - entity_name: Name of the entity, capitalized
            - entity_type: A reasonable entity type such, as but not limited to person, technology, mission, organization, location, etc
                ...
                with concurrent.futures.ThreadPoolExecutor(max_workers=max_workers) as executor:
                    ...
                    try:
                        ...
                        while remaining_futures:
                            ...
                            if time.time() - start_time > 10800:  # 3 hour global timeout
